...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!passwordPattern.test(pass)) {
      setError(
        "Password must be at least 6 character long, and include at least one uppercase, one Lowercase and one special character."
      );
      return;
    }
    setError("");
          ...
          <fieldset className="fieldset">
            ...
            <div>
              <label className="label">
                <input type="checkbox" name="terms" class="checkbox" /> Accept
